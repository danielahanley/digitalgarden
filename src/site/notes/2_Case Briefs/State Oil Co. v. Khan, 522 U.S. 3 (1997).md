...
1. Khan would lease a gas station and convivence store owned by State Oil.[^2] 
2. Khan would obtain his supply of gas from State Oil “at a price equal to a suggested retail price set by State Oil, less a margin of 3.25 cents per gallon.”[^3] 
3. Khan was free to charge customers above State Oil’s selected price, but the excess would be rebated to State Oil.[^4] 
4. Customer prices less than State Oil’s suggest prices would reduce the 3.25 cents-per-gallon margin.[^5] 
...
1. A difference in gasoline prices would have increased his sales. 
2. State Oil had market power in the relevant market.[^9]  
...
First, the Supreme Court analyzed the basis of its _Albrecht_ opinion.
...
The Court then detailed a set of factors to determine whether it should overrule a prior precedent (here its decision in _Albrecht_). The three considerations are:

1. To what extent the current precedent can be harmonized with recent decisions.[^17] 
2. How new scholarship supports or undermines the current precedent.[^18]
